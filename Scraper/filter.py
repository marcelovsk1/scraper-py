...
def scrape_facebook_events(driver, unique_events):
...
def scrape_ticketmaster_events(driver, unique_events):
    scroll_to_bottom(driver)
...
def scrape_eventbrite_events(driver, unique_events):
    scroll_to_bottom(driver)
...
def main():
    ...
    facebook_events = list(scrape_facebook_events(facebook_driver, unique_events))
    ...
    ticketmaster_events = list(scrape_ticketmaster_events(ticketmaster_driver, unique_events))
    ...
    eventbrite_events = list(scrape_eventbrite_events(eventbrite_driver, unique_events))
